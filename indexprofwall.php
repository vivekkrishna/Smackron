...
<script src="wallscriptprof.js" type="text/javascript"></script>
<script src="javascriptprof.js" type="text/javascript"></script>
...
<input type="hidden" name="keepID" id="keepID" value="<?php echo $_SESSION['uid'] ?>" />
<input type="hidden" name="posted_on" id="posted_on" value="<?php echo $_SESSION['uid'] ?>" />
