...
if(!$_SESSION['fullname']){
    echo "<script type='text/javascript'>
        window.location='http://localhost:8082/smackron/index.php';
        </script>";
}else{
?>
<?php
...
<table width="680" style="background-color:white;" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <h2 style="margin-left:24px;">Messages You Sent <?php echo $_SESSION['fullname']; ?></h2>
...
while($row = mysql_fetch_array($sql)){ 
    ...
    $ret = mysql_query("SELECT id, fullname FROM user WHERE id='$to_id' LIMIT 1");
    while($raw = mysql_fetch_array($ret)){ $Rid = $raw['id']; $Rname = $raw['fullname']; }
...
?>
        <table width="96%" border="0" align="center" cellpadding="4">
          <tr>
            ...
            <td width="20%" valign="top"><a href="othersprof.php?uid=<?php echo $Rid; ?>"><?php echo $Rname; ?></a></td>
