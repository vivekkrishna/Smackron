...
UNIX_TIMESTAMP() - t1.date_created AS CommentTimeSpent FROM facebook_posts_comments as t1,user as t2 where t1.post_id = ".$_REQUEST['post_id']." AND t1.userid=t2.id order by t1.c_id desc limit 1");
