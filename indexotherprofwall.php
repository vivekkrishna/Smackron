...
<script type="text/javascript" src="fb/jquery-1.4.2.js"></script>
...
<script src="wallscriptotherprof.js" type="text/javascript"></script>
<script src="javascriptotherprof.js" type="text/javascript"></script>

<script type="text/javascript">
//    window.onload=init(<?php //echo $user_info['id'] ?>);
//    var xmlhttp6;
//    function init(str){
//        //alert(str);
...
//xmlhttp6.open("GET","wallotherprof.php?q6="+str,true);
//xmlhttp6.send();
//    }
...
<input type="hidden" name="keepID" id="keepID" value="<?php echo $user_info['id'] ?>" />
<input type="hidden" name="posted_on" id="posted_on" value="<?php echo $user_info['id'] ?>" />
